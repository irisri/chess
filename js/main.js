...
function getAllPossibleCoordsKnight(pieceCoord) {
    ...
    //from buttom & right
    var i = pieceCoord.i - 1;
    for (var idx = 2; idx > 0 && pieceCoord.j < 8; idx--) {
        var coord = { i: i--, j: pieceCoord.j + idx };
    ...
    //from buttom & left
    i = pieceCoord.i - 1;
    for (var idx = 2; idx > 0 && pieceCoord.j >= 0; idx--) {
        var coord = { i: i--, j: pieceCoord.j - idx };
        //console.log(coord);
        if (!isEmptyCell(coord)) continue;
        res.push(coord);
